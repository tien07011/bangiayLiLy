...
<body>
    ...
    <div class="container">
            <div class="cartegory-1">
                    <div class="cartegory-1-top-item" style="font-family: Courier new;">
                      <h2>GIÀY THỂ THAO</h2>  
                    </div>
                    ...
                    <button style="background: #ffffff;float: right;margin: 15px; border: none;border-radius: 10px"><a href="index_min2.php?id_loai=1" class="button" style="font-size: 20px;"><i class="fas fa-angle-double-right"></i></a></button>
            </div>
            <div class="cartegory-1">
                    ...
                    <button style="background: #ffffff;float: right;margin: 15px; border: none;border-radius: 10px"><a href="index_min2.php?id_loai=2" class="button" style="font-size: 20px;"><i class="fas fa-angle-double-right"></i></a></button>
            </div>
            <div class="cartegory-1">
                    <div class="cartegory-1-top-item">
                      <h2>SCANDAL</h2>  
                   ...
                   <button style="background: #ffffff;float: right;margin: 15px; border: none;border-radius: 10px"><a href="index_min2.php?id_loai=3" class="button" style="font-size: 20px;"><i class="fas fa-angle-double-right"></i></a></button>
            </div>
            <div class="cartegory-1">
                    <div class="cartegory-1-top-item">
                      <h2>BOOT</h2>  
                    ...
                    <button style="background: #ffffff;float: right;margin: 15px; border: none;border-radius: 10px"><a href="index_min2.php?id_loai=4" class="button" style="font-size: 20px;"><i class="fas fa-angle-double-right"></i></a></button>
            </div>
    </div>
