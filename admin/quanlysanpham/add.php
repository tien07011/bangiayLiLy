...
<?php 
    ...
    if (isset($_POST['luu'])) {      
            ...
            $sql1 = 'insert into san_pham(ten_sp,hinh_anh,so_luong,thuong_hieu,gia_goc,gia,id_loai,mau, trang_thai) 
            values ("'. $ten_sp.'","'.$hinh_anh.'","'.$so_luong.'","'.$thuong_hieu.'","'.$gia_goc.'","'.$gia.'","'.$id_loai.'","'.$mau.'","dangban")';
                            ...
                            <div class="panel-body">
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required="true" type="file" class="form-control" id="hinh_anh" name="hinh_anh" value="<?=$hinh_anh?>">
                                    </div>
                                    <div class="form-group">
