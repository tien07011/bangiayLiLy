<?php 
  ...
  $theloai = $_REQUEST["id_loai"] ;
  $sql = "select * from san_pham where trang_thai='dangban' and id_loai= '$theloai'";
  $sanpham = executeResult($sql);
  $sql3 = "select * from loai where id_loai='$theloai'";
  $loai= executeSingleResult($sql3);
...
<body>
    ...
    <div class="container">
            <div class="cartegory-1">
                    ...
                    <button style="background: #ffffff;float: right;margin: 15px; border: none;border-radius: 10px"><a href="home.php" class="button" style="font-size: 20px;"><i class="fas fa-angle-double-left"></i></a></button>
            </div>
