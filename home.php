...
/////////////////
  $sql = "select * from san_pham where trang_thai = 'dangban' AND id_loai = 1 limit 4";
  $sanpham = executeResult($sql);

  $sql = "select * from san_pham where trang_thai='dangban' and id_loai = 2 limit 4";
  $sanpham2 = executeResult($sql);

  $sql = "select * from san_pham where trang_thai='dangban' and id_loai = 3 limit 4";
  $sanpham3 = executeResult($sql);

  $sql = "select * from san_pham where trang_thai='dangban' and id_loai = 4 limit 4";
  $sanpham4 = executeResult($sql);
...
<body>
      ...
      <div class="container-fluid">
       ...
       <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          ...
          {?> 
            <li><a href="thongtintaikhoankhach.php?id_tk=<?=$user['id_tk']?>"><i class="fas fa-user-circle"></i></li></a>
    ...
    <div class="container text-center" style="margin-top: -200px; margin-left: 25%;" >

                <div class="iteam" style="float: left;">

                  <a class="theloai" href="index_min.php?id_loai=1" style="">
                ...
                <div class="iteam" style="float: left;">
                  <a class="theloai" href="index_min.php?id_loai=2" style="">
                    <div class="imgg" style="">
                ...
                <div class="iteam" style="float: left;">
                  <a class="theloai" href="index_min.php?id_loai=3" style="">
                    <div class="imgg" style="">
                ...
                <div class="iteam" style="float: left;">
                  <a class="theloai" href="index_min.php?id_loai=4" style="">
                    <div class="imgg" style="">
    ...
    <div class="container">
            <div class="cartegory-1">
                    <div class="cartegory-1-top-item">
                      <h2>GIÀY THỂ THAO</h2>  
                    </div>
                    <div class="container-text-center">
                      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12" style="animation: moveBottom 2s ease-out;">
                          <a href="chitietsp.php?id_sp=<?php echo $key['id_sp']; ?>" style="width: 100%;" >
                    ...
                    <button style="background: #ffffff;float: right;margin: 15px; border: none;border-radius: 10px"><a href="index_min.php?id_loai=1" class="button" style="font-size: 20px;"><i class="fas fa-angle-double-right"></i></a></button>
            </div>
            <div class="cartegory-1">
                    <div class="cartegory-1-top-item">
                      <h2>GIÀY CAO GÓT</h2>  
                    ...
                    <button style="background: #ffffff;float: right;margin: 15px; border: none;border-radius: 10px"><a href="index_min.php?id_loai=2" class="button" style="font-size: 20px;"><i class="fas fa-angle-double-right"></i></a></button>
            </div>
            <div class="cartegory-1">
                    <div class="cartegory-1-top-item">
                      <h2>SCANDAL</h2>  
                    ...
                    <div class="container-text-center">
                      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        <?php
                        foreach ($sanpham3 as $key) {
                        ?>
                      
                        <div class="col-lg-3 col-sm-6 col-12" style="animation: moveBottom 5s ease-out;">
                          <a href="chitietsp.php?id_sp=<?php echo $key['id_sp']; ?>" style="width: 100%;" >
                   ...
                   <button style="background: #ffffff;float: right;margin: 15px; border: none;border-radius: 10px"><a href="index_min.php?id_loai=3" class="button" style="font-size: 20px;"><i class="fas fa-angle-double-right"></i></a></button>
            </div>
            <div class="cartegory-1">
                    <div class="cartegory-1-top-item">
                      <h2>BOOT</h2>  
                    ...
                    <div class="container-text-center">
                      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        <?php
                        foreach ($sanpham4 as $key) {
                        ?>
                      
                        <div class="col-lg-3 col-sm-6 col-12" style="animation: moveBottom 3s ease-out;">
                          <a href="chitietsp.php?id_sp=<?php echo $key['id_sp']; ?>" style="width: 100%;" >
                    ...
                    <button style="background: #ffffff;float: right;margin: 15px; border: none;border-radius: 10px"><a href="index_min.php?id_loai=4" class="button" style="font-size: 20px;"><i class="fas fa-angle-double-right"></i></a></button>
            </div>
    </div>
